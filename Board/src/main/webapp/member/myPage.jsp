...
<form action="/update.mem" method="post">
        <div class="container">
        	<!-- title -->
            <div class="row ">
                <div class="a col-12 text-center align-self-center">회원 정보 수정</div>
            </div>
            <!-- id -->
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-9 align-self-center">
                    <input class="align-self-center" type="text" id="input-name" name="name" value="${dto.name }">
                </div>
                <div class="a col-3 align-self-center" style="padding:0"></div>
                <div class="col-9 d-flex" id="check" style="padding-top:0;padding-bottom:0;">
            ...
            <div class="row">
                ...
                <div class="col-9 align-self-center">
                    <input class="align-self-center" type="text" id="phone" name="phone" value="${dto.phone }">
                </div>
                <div class="a col-3 align-self-center" style="padding:0"></div>
                <div class="col-9" id="check" style="padding-top:0;padding-bottom:0;">
            ...
            <script>
	            ...
	            let phoneCheck = function(){
	                let phoneVal = phoneRegex.test($("#phone").val());
	                if(!phoneVal){
	                    $("#phone-result").html("번호를 확인해주세요."); 
	            ...
	            $("#phone").on("input",phoneCheck);
	            $("#phone").on("focus",phoneCheck);
            ...
            <div class="row">
                ...
                <div class="col-9 align-self-center">
                    <input type="text" id="input-email" name="email" value="${dto.email }">
                </div>
                <div class="a col-3 align-self-center" style="padding:0"></div>
                <div class="col-9 d-flex" id="check" style="padding-top:0;padding-bottom:0;">
            ...
            <div class="row">
                ...
                <div class="col-9 align-self-center">
                    <input class="align-self-center" type="text" id="zipCode" name="zipCode" value="${dto.zipcode}">
            ...
            <div class="row">
                ...
                <div class="col-9 align-self-center">
                    <input class="align-self-center" type="text" class="add" id="address1" name="address1" value="${dto.address1 }">
                </div>
            </div>
            <div class="row">
                <div class="a col-3 align-self-center">주소2 :</div>
                <div class="col-9 align-self-center">
                    <input class="align-self-center" type="text" class="add" id="address2" name="address2" value="${dto.address2}">
                </div>
            </div>
    		<!-- 다음 API 사용 -->
            <script>
            ...
            <script>
                ...
                $("#signup").on("click",function(){
                	let isAllFillIn = nameFlag&&phoneFlag&&emailFlag&&addressFlag;
                    if(!isAllFillIn){
